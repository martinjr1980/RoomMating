...
module.exports = function Routes(app, io){
 ...
 app.get('/profile/:id', function(req,res) { users.profile(req,res) });
 app.get('/users/logout', function(req,res) { users.logout(req,res) });
 ...
 app.post('/users/askQuestions', function (req, res) { users.askQuestions (req, res) });
 // app.get('/users', function(req,res) { users.index(req,res) });
